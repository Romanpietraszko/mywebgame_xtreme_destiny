...
function drawNotebookPuddle(ctx, x, y, radius, numPoints, randomOffsetLimit) {
    ...
    // Rysowanie organicznego, naszkicowanego koła za pomocą lineTo z MIEJSCOWYM odchyleniem
    ctx.beginPath();
    for (let i = 0; i < numPoints; i++) {
        let angle = (i / numPoints) * Math.PI * 2;
        
        // Używamy sinusa i cosinusa z pozycją (x, y) jako "seedem".
        // Zamiast Math.random() co klatkę, to równanie zawsze da ten sam wynik dla tej samej kałuży.
        // Dzięki temu plama jest pofalowana, ale statyczna i nie drży!
    ...
    // Dodanie dwóch małych "kropli" atramentu wokół plamy dla lepszego efektu
    ctx.beginPath();
